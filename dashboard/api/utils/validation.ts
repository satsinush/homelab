...
class ValidationUtils {
    ...
    static validateAndNormalizeMac(mac: string): string {
        if (!mac) {
    ...
    static validateDeviceName(name: string): string {
        if (!name) {
    ...
    static validateDeviceDescription(description: string | null | undefined): string {
